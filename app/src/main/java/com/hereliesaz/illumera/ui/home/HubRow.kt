...
fun HubRow(
    ...
    val itemWidth = when (hubGroup.shape) {
        com.hereliesaz.illumera.domain.HubShape.HORIZONTAL -> 190.dp
        com.hereliesaz.illumera.domain.HubShape.VERTICAL -> 120.dp
        com.hereliesaz.illumera.domain.HubShape.SQUARE -> 140.dp
    }
